  ...
  return (
    <div className="page-enter p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        {[
          { label: "Total Debates", value: liveStats.totalDebates, color: "var(--text-primary)" },
          { label: "Live Now", value: liveStats.liveDebates, color: "var(--accent-rose)" },
          { label: "Total Rounds", value: liveStats.totalRounds, color: "var(--accent-indigo)" },
          { label: "Verifications", value: liveStats.totalVerifications, color: "var(--accent-emerald)" },
          { label: "Avg Spectators", value: liveStats.averageSpectators, color: "var(--accent-amber)" },
        ].map((s) => (
